...
using ControlDeInventario.Blazor.Server.Services;
...
using ControlDeInventario.WebApi.JWT;
using DevExpress.ExpressApp.Security.Authentication;
using DevExpress.ExpressApp.Security.Authentication.ClientServer;
using ControlDeInventario.Module.BusinessObjects;

namespace ControlDeInventario.Blazor.Server;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<ControlDeInventarioBlazorApplication>();
            ...
            builder.AddXafWebApi(webApiBuilder => {
                ...
                webApiBuilder.ConfigureOptions(options => {
                    ...
                    // Make the Category, Product, and Supplier business objects available in the Web API
            ...
            builder.Modules
                ...
                .AddViewVariants()
                .Add<ControlDeInventario.Module.ControlDeInventarioModule>()
            	.Add<ControlDeInventarioBlazorModule>();
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(ControlDeInventario.Module.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(ControlDeInventario.Module.BusinessObjects.ApplicationUserLoginInfo);
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "ControlDeInventario API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the ControlDeInventario.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
            });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "ControlDeInventario WebApi v1");
            });
        }
        else {
